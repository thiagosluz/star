...
> **Estado:** FASES 1 a 17, 21 a 25, 29 a 43 concluídas (F15, F21, F22, F29–F43 entregues; a F44+ é a próxima) · **2228 testes** unitários/integração · **148 testes E2E**
...
```bash
npm test                  # 2228 testes (97 arquivos) — unit + integração com banco real
npm run test:e2e          # 148 testes E2E contra o container de produção
...
| [`docs/dividas-tecnicas.md`](docs/dividas-tecnicas.md) | **Levantamento consolidado:** 56 dívidas abertas (o levantamento original mais o que cada fase declarou), verificadas no código, por tema, com esforço e fases candidatas numeradas como as fases que serão entregues | — |
