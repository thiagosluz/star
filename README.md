...
> **Estado:** FASES 1 a 17, 21 a 25, 29 a 44 concluídas (F15, F21, F22, F29–F44 entregues; a F45+ é a próxima) · **2272 testes** unitários/integração · **150 testes E2E**
...
```bash
npm test                  # 2272 testes (99 arquivos) — unit + integração com banco real
npm run test:e2e          # 150 testes E2E contra o container de produção
