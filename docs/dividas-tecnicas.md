...
> estorno no cancelamento), com as
> **revisões
...
| **Total** | **56** | **13** | (as fases quitadas estão item a item nas tabelas: 8 na FASE 12 · 5 na FASE 13 · 3 na FASE 14 · 7 na FASE 15 · 8 na FASE 16 · 4 na FASE 17 · 2 na FASE 21 · 6 na FASE 22 · 5 na FASE 23 · 4 na FASE 24 · 1 na FASE 33 · **3 na FASE 36** — A3, B7 e E47 — · **2 na FASE 37** — E41 e E48 — mais o escopo próprio da FASE 25 e as revisões) |
...
> da inscrição não é estornado quando a pessoa cancela): **56**.
>
> O total é a **soma das tabelas de tema** (3+4+2+3+34+5+0+4+1 = 56 — o tema G ficou
