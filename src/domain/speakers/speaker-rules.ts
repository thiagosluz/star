 ...
 * Token de convite.
 *
 * 32 caracteres de um alfabeto de 32 símbolos = 160 bits. O alfabeto exclui
 * `I`, `O`, `0` e `1` porque o token vai ser DITADO por telefone ou copiado de um
 * papel — e a confusão entre `l`/`1` e `O`/`0` é o defeito clássico de código
 * impresso (a mesma razão do alfabeto do código de validação de certificado).
 */
